...
/// On-device Apple Intelligence (Foundation Models, macOS 26+) for UI-string
/// translation. Nothing is sent to a server. If the model is unavailable
/// (older macOS, Intel Mac, or Apple Intelligence off), Dart falls back to
/// Apple Translation, then Mistral.
